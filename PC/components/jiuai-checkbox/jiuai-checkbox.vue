<template>
	<view
		...
		:style="{ border: borderStyle, width: checkBoxSize + 'px', height: checkBoxSize + 'px', 'line-height': checkBoxSize + 'px','border-radius':borderRadius+'px'}"
		@click="clickChecked"
	>
		<view :class="['jiuai-check-icon', 'iconfont', 'icon-xuanzhong', isChecked ? 'active' : '']" :style="{ color: color }"></view>
	</view>
</template>
