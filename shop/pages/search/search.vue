		...
		<view class="wrapper">
			<view class="search">
				<view class="search-box">
					...
					<input type="text" v-model="val" placeholder="大家都在搜">
				</view>
				<view @tap="goType">搜索</view>
			</view>
			<mescroll-uni :down="downOption" @down="downCallback" :up="upOption" @up="upCallback" @init="mescrollInit"
			@emptyclick="emptyClick" @topclick="topClick">
				<view class="lists">
					<view class="item" v-for="(v,k) in list" :key="k" @tap="goDetail(v.productId)">
						<img :src="v.image" alt="">
						<view class="product">
							<view class="product-title">{{v.title}}</view>
							<view class="product-msg">
								<view class="product-price">
									<view style="color: red;margin-right: 60upx;">￥{{v.price}}</view>
									<view style="color: #999;">已收{{v.sales ? v.sales : 0}}</view>
								</view>
								<view class="btns">我有货</view>
							</view>
						</view>
					</view>
				</view>
