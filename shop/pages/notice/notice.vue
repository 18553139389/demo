	...
	<view class="contain">
		<view class="fixed">
			<cu-custom :isBack="true" :Color="Color" :isIcon="true" bgColor="bg-shadeTop text-white">
				...
				<block slot="content">公告通知</block>
			</cu-custom>
		</view>
		<view class="wrapper">
			<mescroll-uni :down="downOption" @down="downCallback" :up="upOption" @up="upCallback" @init="mescrollInit"
			@emptyclick="emptyClick" @topclick="topClick">
				<view class="question" v-for="(v,k) in list" :key="k" @tap="goDetail(v)">
					<view>{{v.title}}</view>
	...
	export default {
		...
		methods: {
			...
			goDetail(list) {
				...
				let content = encodeURIComponent(list.url)
				uni.navigateTo({
				    url: `/pages/textDetail/textDetail?title=${title}&content=${content}`
				})
			}
		}
	}
