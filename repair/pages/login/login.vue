<template>
	<view class="contain">
		<view class="wrapper">
			...
			<view class="forms">
				<view class="item">
					<image class="pass" src="../../static/images/call.png"></image>
				...
				<view class="submit" @tap="goLogin">登陆</view>
				<!-- <view class="item">
					<image class="pass" src="../../static/images/pass.png" style="width: 40rpx;height: 40rpx;margin:0 30rpx 0 10rpx;"></image>
