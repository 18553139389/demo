<template>
	<view class="contain">
		...
		<view class="wrapper">
			...
			<view class="item" style="padding-bottom: 0;" v-show="hide3" @tap="goChoice">
				<view class="sku">
					<view class="sku-left">
