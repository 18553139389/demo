	...
	<view class="contain">
		...
		<view class="wrapper">
			...
			@emptyclick="emptyClick" @topclick="topClick">
				<view class="list">
					<uni-swipe-action>
						<uni-swipe-action-item :options="options1" v-for="(v,k) in list" :key="k" @click="bindClick(v.msgId)">
							<view class="item">
								<view class="top">
									<view class="top-left">
										<image src="../../static/images/xiaoxiliebiao.png"></image>
										<view>{{v.title}}</view>
									</view>
									<view style="font-weight: 500;">{{v.createDate}}</view>
								</view>
