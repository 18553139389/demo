	...
	<view class="contain">
		<view class="fixed">
			<cu-custom :isBack="false" :Color="Color" :backColor="backColor" :isIcon="true" bgColor="bg-shadeTop text-white">
				<block slot="content">合同管理</block>
			</cu-custom>
		</view>
		<view class="wrapper">
			<view class="search">
				<image src="../../static/images/search.png"></image>
				<input type="text" v-model="val" confirm-type="search" placeholder="请输入关键字搜索" @confirm="confirm">
			</view>
			<mescroll-uni :down="downOption" @down="downCallback" :up="upOption" @up="upCallback" @init="mescrollInit"
			@emptyclick="emptyClick" @topclick="topClick">
				<view class="list">
					<view class="list-item" v-for="(v,k) in list" :key="k" @tap="goPreview(v.fileUrl,v.id)">
