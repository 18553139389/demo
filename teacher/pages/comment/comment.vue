		...
		<view class="wrapper">
			...
			@emptyclick="emptyClick" @topclick="topClick">
				<view class="item" v-for="(v,k) in list" :key="k">
					<img src="../../static/images/center.png" alt="">
					<view class="message">
						<view class="user">
							<view>匿名用户</view>
							<!-- <uni-rate :value="v.serviceEv" size="16" active-color="#FE7A38" disabled="true" style="margin-top: 10upx;margin-left: 24upx;"></uni-rate> -->
						</view>
						<view class="time">评论时间：{{v.commentTime}}</view>
						<view class="speak">
							<view class="speak-item" v-for="(item,index) in v.tagList" :key="index">{{item}}</view>
						</view>
					</view>
				</view>
			</mescroll-uni>
