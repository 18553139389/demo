<template>
	<view class="contain">
		...
		<view class="wrapper">
			<view class="money"><span style="font-size: 28upx;">￥</span>{{balance}}</view>
			<view class="entry" @tap="goApply">申请提现</view>
			<view class="list">
				<view class="titles">交易明细</view>
				...
				@emptyclick="emptyClick" @topclick="topClick">
					<view class="item" v-for="(v,k) in list" :key="k">
						...
						<view class="price" v-if="v.transactionType == 1">+{{v.value}}</view>
						<view class="price" v-if="v.transactionType == 2">-{{v.value}}</view>
					</view>
				</mescroll-uni>
			</view>
		</view>
