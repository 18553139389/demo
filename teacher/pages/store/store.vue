			...
			<view class="first">
				...
				<view class="lists">
					<view class="list-item" v-for="(v,k) in list" :key="k">
						...
						<view class="center" style="color: #0e4ca0;">{{v.inventory}}</view>
					</view>
				</view>
			</view>
		</view>
		<view class="count" @tap="goUsed">使用统计</view>
	</view>
</template>
		...
		methods: {
			...
			init() {
				...
				Toast.showLoading('', function() {
					let data = {
						url: 'app/service/maintainer/part/list',
						data: data1,
