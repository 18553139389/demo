<template>
  <div class="wrapper">
    ...
    <div class="list">
      <div class="titles">艺术类数据查询</div>
      <div class="list-item">
        <div class="notice-left" @click="goCommon">
          <div class="cards">艺术类招生院校查询</div>
          <div class="imgs">
            <img :src="yszsIcon" alt="">
          </div>
        </div>
        <div class="notice-left" @click="goArt">
          <div class="cards">艺术类院校排名</div>
          <div class="imgs">
            <img :src="ysyxIcon" alt="">
          </div>
        </div>
        <div class="notice-left" @click="goSchool">
          <div class="cards">按院校名称查询</div>
          <div class="imgs">
            <img :src="ysmcIcon" alt="">
          </div>
        </div>
      </div>
    </div>
      ...
      init() {
        Request.postRequest('jinxiuqiancheng/api/getIcon').then(res => {
          if (res.data.result == 0) {
            this.yszsIcon = res.data.yszsIcon
            this.ysyxIcon = res.data.ysyxIcon
            this.ysmcIcon = res.data.ysmcIcon
          } else {
