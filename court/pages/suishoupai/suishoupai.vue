		...
		<mescroll-uni :down="downOption" @down="downCallback" :up="upOption" @up="upCallback" @init="mescrollInit"
		 @emptyclick="emptyClick" @topclick="topClick">
			<view class="list" @tap="goDetail(v)" v-for="(v,k) in list" :key="k">
				<view class="tit" v-if="v.complType == 1">环境保护</view>
				<view class="tit" v-if="v.complType == 2">国土资源</view>
				<view class="tit" v-if="v.complType == 3">食药安全</view>
				<view class="tit" v-if="v.complType == 4">国土安全</view>
				<view class="tit" v-if="v.complType == 5">国有财产</view>
				<view class="tit" v-if="v.complType == 6">英烈保护</view>
				<view class="tit" v-if="v.complType == 7">其他</view>
				<view class="content">{{v.content}}</view>
				<view class="msg">
					<view>{{v.location}}</view>
