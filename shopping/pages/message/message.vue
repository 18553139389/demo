	...
	<view class="contain">
		...
		<view class="wrapper">
			...
			@emptyclick="emptyClick" @topclick="topClick">
				<view class="lists" v-for="(v,k) in list" :key="k">
					<uni-swipe-action>
						<uni-swipe-action-item :options="options1" @click="bindClick(v.msgId)">
							<view class="list">
								<image src="../../static/images/notice.png"></image>
								<view class="message">
									<view class="titles">
										<view class="left">{{v.title}}</view>
										<view class="right">{{v.createDate}}</view>
									</view>
