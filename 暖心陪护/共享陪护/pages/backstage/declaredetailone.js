...
// pages/backstage/declaredetailone.js
Page({
  ...
  data: {
    imgup: "", //上传图片地址
    jiancha: "", //检查结果  0-故障，1-正常 (如果是未修好的就不用传了)
    weixiu: "", //维修结果 1-未修好，2-已修好
    txtCont: "", //文本框内容
  ...
  onLoad: function(options) {
    ...
    // errorApplyId = "638d30849a874635852d86b662f623c2";
  ...
  submitbtn: function() {
    ...
    wx.request({
      ...
      data: {
        ...
        jcResult: _this.data.jiancha, //检查结果：0-故障，1-正常 (如果是未修好的就不用传了)
        wxResult: _this.data.weixiu, //维修结果：1-未修好，2-已修好
