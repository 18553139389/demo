							...
							Request.postRequest('api/licence/region/list').then(response => {
								if (response.data.success == true) {
									if (response.data.body !== undefined || response.data.body !== {}) {
										...
										for(let j = 0; j < self.listData1.length; j++) {
											self.listData1[j]['carSb'] = self.listData1[j]['carSb'].substr(0,self.listData1[j]['carSb'].length-1)
										}
									}
								}
							})
						...
						if (res.data.body.permits.length > 0) {
							...
							Request.postRequest('api/licence/region/list').then(response => {
								...
								if (response.data.success == true) {
									...
									for(let j = 0; j < self.listData2.length; j++) {
										self.listData2[j]['carSb'] = self.listData2[j]['carSb'].substr(0,self.listData2[j]['carSb'].length-1)
									}
								}
							})
						}else{
						...
						if (res.data.body.permits.length > 0) {
							...
							Request.postRequest('api/licence/region/list').then(response => {
								if (response.data.success == true) {
									...
									for(let j = 0; j < self.listData3.length; j++) {
										self.listData3[j]['carSb'] = self.listData3[j]['carSb'].substr(0,self.listData3[j]['carSb'].length-1)
									}
								}
							})
						}else{
						...
						if (res.data.body.permits.length > 0) {
							...
							Request.postRequest('api/licence/region/list').then(response => {
								if (response.data.success == true) {
									...
									for(let j = 0; j < self.listData4.length; j++) {
										self.listData4[j]['carSb'] = self.listData4[j]['carSb'].substr(0,self.listData4[j]['carSb'].length-1)
									}
								}
							})
						}else{
