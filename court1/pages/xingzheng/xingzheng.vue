		...
		<view class="list">
			...
			<view class="forms">
				...
				<view class="form-item" @tap="shows">
					<view>性别</view>
					<view style="color: #999;" v-if="radio == 1">男</view>
					<view style="color: #999;" v-if="radio == 2">女</view>
				</view>
				<view class="form-item">
					<view>身份证号</view>
			...
			<view class="tit" style="margin-top: 30upx;">申诉内容</view>
			<view class="content">
				<textarea v-model="content" placeholder="申诉内容" placeholder-class="place" />
			</view>
