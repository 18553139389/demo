<template>
	<view class="contain">
			 ...
			 @emptyclick="emptyClick" @topclick="topClick">
				<view class="item" v-for="(v,k) in list" :key="k">
					<view class="list-item">
						...
						<view class="right">{{v.suspect}}</view>
					</view>
					<view class="list-items">
						<view style="width: 25%;">案由：</view>
						<view class="right">{{v.cause}}</view>
					</view>
					<view class="list-item">
						<view style="width: 25%;height: 60upx;line-height: 60upx;">预约时间：</view>
						<view class="right" style="height: 60upx;line-height: 60upx;">{{v.readingDate}}</view>
					</view>
		...
		<img @tap="goPublic" class="public" src="../../static/img/fabu.png" alt="">
	</view>
</template>
